...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('mail.photomunkey.com', 26)
	  ->setUsername('thefutureofmedia@photomunkey.com')     
	  ->setPassword('Futures31!')
	  ;
	...
	$message = Swift_Message::newInstance('A message from Future of Media Registration Form')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('thefutureofmedia@photomunkey.com' => 'marisa tovar'))->setBody($messageText);
//                           ^                    ^
